      ...
      <div class="col-lg-8 col-md-7 col-sm-12 col-12">
        ...
        <?php
                ...
                if(isset($_GET['id'])){
                  ...
                  $sql1 = "SELECT * FROM post JOIN sub_category
                          ON post.sub_category = sub_category.sub_category_id
                          WHERE post.sub_category = {$sub_category_id}";                  
       ...
       <?php
                ...
                if(isset($_GET['id'])){
                  ...
                  $sql2 = "SELECT * FROM sub_category   WHERE sub_category_id = {$sub_category_id}";                  

                  $result2 = mysqli_query($conn, $sql2) or die("Query Failed.");
                  $row2 = mysqli_fetch_assoc($result2);

        ?>
       <h2 class="card"><?php echo $row2['sub_category_name']; ?> News</h2>
        ...
        <div class="card">
          <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12">
              ...
              <div class='post-info'>
                <h3 class='post-title'>
                  <a href='single.php?pid=<?php echo $row['post_id']; ?>&cid=<?php echo $row['category']; ?>&id=<?php echo $row['sub_category']; ?>'><?php echo $row['title']; ?></a>
                </h3>
                <div class='post-meta'>
                ...
                <a class="btn btn-outline-dark" href="single.php?pid=<?php echo $row['post_id']; ?>&id=<?php echo $row['sub_category']; ?>&cid=<?php echo $row['category']; ?>">Read
                  More</a>
              </div>
              ...
              <nav aria-label="Page navigation example">
                <?php
                    ...
                    if(mysqli_num_rows($result1) > 0){
                      ...
                      if($page > 1){
                        echo '<li class="page-item"><a class="page-link" href="sub_category.php?id='.$sub_category_id .'&page='.($page - 1).'">Previous</a></li>';
                      }
                      for($i = 1; $i <= $total_page; $i++){
                        ...
                        echo '<li class="page-item"><a  class="'.$active.'" class="page-link" href="sub_category.php?id='.$sub_category_id .'&page='.$i.'">'.$i.'</a></li>';
                      }
                      if($total_page > $page){
                        echo '<li class="page-item"><a class="page-link" href="sub_category.php?id='.$sub_category_id .'&page='.($page + 1).'">Next</a></li>';
                      }
