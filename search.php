    ...
    <div class="row">
      <div class="col-lg-8 col-md-7 col-sm-12 col-12">
          ...
          <?php
                  ...
                  ?>
          <h2 class="card">Search : <?php echo $search_term; ?></h2>
          <?php
                    ...
                    WHERE post.title LIKE '%{$search_term}%' 
                       ...
                       OR sub_category.sub_category_name LIKE '%{$search_term}%'
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result1) > 0){
                      ...
                      for($i = 1; $i <= $total_page; $i++){
                        ...
                        echo '<li class="page-item"><a  class="'.$active.'" class="page-link" href="search.php?search='.$search_term .'&page='.$i.'">'.$i.'</a></li>';
                      }
                      if($total_page > $page){
