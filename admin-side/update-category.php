...
<div class="main_div1">
  ...
  <div class="box1">
    ...
    <div class="inputBox">
                ...
                <input type="text" name="category_name"  value="<?php echo $row['category_name']; ?>"  autocomplete="off" required>
...
<?php
  if(isset($_POST['submit'])){
    ...
    $sql1 = "UPDATE category SET category_id='{$_POST['category_id']}', category_name='{$_POST['category_name']}'  WHERE  category_id={$_POST['category_id']}";
