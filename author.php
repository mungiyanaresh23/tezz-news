    ...
    <div class="row">
      <div class="col-lg-8 col-md-7 col-sm-12 col-12">
        ...
        <?php
                ...
                ?>
        <h2 class="card">News By <?php echo $row1['username']; ?></h2>
        <?php
            ...
            <nav aria-label="Page navigation example">
              <?php
                    ...
                    if(mysqli_num_rows($result1) > 0){
                      ...
                      if($page > 1){
                        echo '<li class="page-item"><a  class="page-link" href="author.php?aid='.$author_id .'&page='.($page - 1).'">Previous</a></li>';
                      }
                      for($i = 1; $i <= $total_page; $i++){
                        ...
                        echo '<li  class="page-item"><a class="'.$active.'" class="page-link" href="author.php?aid='.$author_id .'&page='.$i.'">'.$i.'</a></li>';
                      }
                      if($total_page > $page){
                        echo '<li class="page-item"><a class="page-link" href="author.php?aid='.$author_id .'&page='.($page + 1).'">Next</a></li>';
                      }
