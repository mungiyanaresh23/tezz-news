  ...
  <div class="news-content">
    ...
    <div class="row">
      ...
      <?php
       ...
       <h2 class="card"><?php echo $row2['category_name']; ?> News</h2>
        ...
        <div class="card">
          <div class="row">
            ...
            <div class="col-lg-7 col-md-12 col-sm-12 col-12">
              ...
              <div class='post-info'>
                <h3 class='post-title'>
                  <a href='single.php?pid=<?php echo $row['post_id']; ?>&id=<?php echo $row['sub_category']; ?>&cid=<?php echo $row['category']; ?>'><?php echo $row['title']; ?></a>
                </h3>
                <div class='post-meta'>
          ...
          <div class="col-lg-8 col-md-6 col-sm-10 col-10">
            <nav aria-label="Page navigation example">
              <?php
                    ...
                    if($page > 1){
                      echo '<li class="page-item"><a class="page-link" href="category.php?id='.$category_id .'&page='.($page - 1).'">Previous</a></li>';
                    }
                    for($i = 1; $i <= $total_page; $i++){
                      ...
                      echo '<li class="page-item"><a  class="'.$active.'" class="page-link" href="category.php?id='.$category_id .'&page='.$i.'">'.$i.'</a></li>';
                    }
                    if($total_page > $page){
                      echo '<li class="page-item"><a class="page-link" href="category.php?id='.$category_id .'&page='.($page + 1).'">Next</a></li>';
                    }
